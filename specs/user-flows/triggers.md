...
* Asegurate que en la llamada a Gemini utilizas la directiva generateContent
* En la medida de lo posible se deberán paralelizar hasta 3 peticiones (siendo esto configurable)
...
* No debes utilizar el emulador de Firebase
* El despliegue lo haremos nosotros manualmente.
